...
/**
 * Class ProfileRequest represents the request for updating a user's profile information.
 *
...
class ProfileRequest extends FormRequest
{
    ...
    /**
     * Get the attributes' human-readable names for validation error messages.
     *
     * @return array
     */
