    ...
    <header class="flex justify-between items-center p-3 h-14 shadow bg-white">
        ...
        <Menu as="div" class="relative inline-block text-left">
            <MenuButton class="flex items-center">
                ...
                <ChevronDownIcon aria-hidden="true" class="h-5 w-5 text-indigo-200 hover:text-indigo-100"/>
            </MenuButton>
                        ...
                        <MenuItem v-slot="{ active }">
                            ...
                            'group flex w-full items-center rounded-md px-2 py-2 text-sm',
                                ...
                                <UserIcon :active="active"
                                          :class="[active ? 'mr-2 h-5 w-5 text-white' : 'mr-2 h-5 w-5 text-indigo-700']"
                                          aria-hidden="true"/>
                                Profile
                            </button>
                        </MenuItem>
...
import {LogoutIcon, MenuIcon, UserIcon} from "@heroicons/vue/outline";
